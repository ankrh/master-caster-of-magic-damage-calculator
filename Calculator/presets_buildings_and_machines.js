...
definePresets({
  ...
  hillfortMeleeUnaffectedWarlord: {
    ...
    vacuity: {
      ...
      'b.ability.hillfort':
        'Keep, and the absence is the rule under test. Hillfort is Missile Immunity under another name (`calcKey: \'missileImmunity\'`, enchantments.js:138, resolved at ability_gating.js:27), and the immunity write at combat_effects.js:470 is gated on `ctx.isMissile`, which only the ranged arm of computeCasterDefenseForAttack sets (combat_effects.js:681). The melee arm builds no such field at all (combat_effects.js:650-657), so def 2 stands and 3 - 2 = 1. hillfortMissileWarlord is the positive arm at 0 against this 1; it is not a one-value sibling, since it also swaps the melee attack for a missile one and sets rangedCheck and rangedDist.',
    },
  },
  ...
  temporalTwistStripsFirstStrikeWarlord: {
    ...
    b: { atk:5, hitChance:70, hp:10 },
    expected: { dmgToA: 5.000, sdDmgToA: 0.000, dmgToB: 10.000, sdDmgToB: 0.000 },
    vacuity: {
  ...
  temporalTwistStripsTeleportingWarlord: {
    ...
    b: { atk:5, hitChance:70, hp:10 },
    expected: { dmgToA: 4.000, sdDmgToA: 0.000, dmgToB: 10.000, sdDmgToB: 0.000 },
    vacuity: {
  ...
  temporalTwistTacticianRestoresNonCorporealNegateWarlord: {
    ...
    expected: { dmgToA: 5.000, sdDmgToA: 0.000, dmgToB: 9.000, sdDmgToB: 0.000 },
    vacuity: {
  ...
  rageMeleePreCombatLossWarlord: {
    ...
    b: { atk:0, def:0, hp:30 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 12.000, sdDmgToB: 0.000, regDmgToA: 3.000, sdRegDmgToA: 0.000 },
  },
  ...
  rageDynamicCounterFirstStrikeWarlord: {
    ...
    expected: { dmgToA: 12.000, sdDmgToA: 0.000, dmgToB: 3.000, sdDmgToB: 0.000 },
  },
  ...
  altarOfTheMoonResistanceWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.600, sdDmgToB: 2.728, bonusHpToA: 3.600, sdBonusHpToA: 2.728, regDmgToB: 0.000, sdRegDmgToB: 0.000, undDmgToB: 3.600, sdUndDmgToB: 2.728 },
  },
  ...
  altarOfTheMoonWitchdoctorLifeStealWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 2.100, sdDmgToB: 2.166, bonusHpToA: 2.100, sdBonusHpToA: 2.166, regDmgToB: 0.000, sdRegDmgToB: 0.000, undDmgToB: 2.100, sdUndDmgToB: 2.166 },
  },
  ...
  lavaSmelterProtectionsStackWarlord: {
    ...
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 4.700, sdDmgToB: 0.458 },
    vacuity: {
      'name-binds-nothing':
  ...
  ludusAgogeResistanceWarlord: {
    ...
    expected: { dmgToA: 0.300, sdDmgToA: 0.458, dmgToB: 0, sdDmgToB: 0.000 },
  },
  ludusAgogeHpWarlord: {
    ...
    expected: { dmgToA: 0.300, sdDmgToA: 0.458, dmgToB: 6.000, sdDmgToB: 0.000 },
  },
  ...
  motherFungusToDefendWarlord: {
    ...
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 8.000, sdDmgToB: 1.095 },
  },
  ...
  sanctaBasilicaNonHighMenWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.000, sdDmgToB: 4.583 },
    vacuity: {
  ...
  venomBoostsExistingPoisonWarlord: {
    ...
    b: { atk:0, def:1, toBlkMod:70, res:5, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 1.800, sdDmgToB: 0.849 },
  },
  venomGrantsPoisonImmunityWarlord: {
    ...
    expected: { dmgToA: 1.000, sdDmgToA: 0.000, dmgToB: 0.000, sdDmgToB: 0.000 },
    vacuity: {
      'a.ability.poison':
  ...
  artificerMechanicalDefenseWarlord: {
    ...
    expected: { dmgToA: 0.400, sdDmgToA: 0.490, dmgToB: 4.000, sdDmgToB: 0.000 },
  },
  artificerMechanicalResistanceWarlord: {
    ...
    expected: { dmgToA: 0.280, sdDmgToA: 0.449, dmgToB: 3.000, sdDmgToB: 4.583 },
  },
  ...
  artificerSkipsThrownAndBreathWarlord: {
    ...
    b: { def:0, hp:30 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 8.400, sdDmgToB: 0.490 },
  },
  artificerDoomGazeUnchangedWarlord: {
    ...
    b: { hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 5.400, sdDmgToB: 0.490 },
  },
  ...
  mechanicalExpertNoBonusForNonMechanicalWarlord: {
    ...
    b: { def:0, hp:20 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.000, sdDmgToB: 1.449 },
    vacuity: {
      'every-feature-inert':
  ...
  mechanicalExpertRebuildMakesMechanicalWarlord: {
    ...
    b: { def:0, hp:30 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 6.000, sdDmgToB: 1.732 },
  },
  mechanicalExpertRebuildHeroNoBonusWarlord: {
    ...
    b: { def:0, hp:30 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.600, sdDmgToB: 1.587 },
    vacuity: {
      'a.ability.mechanicalExpert':
  ...
  rebuildArmorWarlord: {
    ...
    expected: { dmgToA: 0.600, sdDmgToA: 0.648, dmgToB: 3.000, sdDmgToB: 0.000 },
  },
  ...
  colossalStrengthMeleeWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 13, sdDmgToB: 0.000 },
  },
  ...
  colossalStrengthScalesBuffedMeleeWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 17, sdDmgToB: 0.000 },
  },
  ...
  rustFantasticUnaffectedWarlord: {
    ...
    vacuity: {
      'a.ability.rust':
        'Keep, and the absence is the rule under test: `rustActiveAt` reads the permanent record\'s Fantastic flag (stats.js), so on a fantastic creature the curse is inactive and every half of it closes at once - the -3 melee (combat_abilities.js:1107, from `SETSTAT(U,SAttack,0,…-3)` at UnitCalc.CAS!NOTCITY!+13 "SETSTAT(U,SAttack,0,(GetStat(U,SAttack,0)-3));"), the weapon strip (stats.js:276), the Large Shield clear (stats.js:1622) and the Thrown clear (stats.js:1628-1632). The exclusion is a targeting restriction read at the permanent record rather than at the step\'s own rank, which `rustActiveAt` (stats.js) states and the script supports: its Rust block is gated on `GETENCHANTMENTFLAG(U,EncRust,0)` alone (UnitCalc.CAS!NOTCITY!+11 "IF (GETENCHANTMENTFLAG(U,EncRust,0)=0) THEN { GOTO") and makes no Fantastic test of either record. a.unitType=fantastic_chaos is the live half. rustMeleePenaltyWarlord is this fixture without that field and pins 7 against this 10; ablation assigns `unitType: \'normal\'` (tools/preset_vacuity_sweep.js:204, written at :300), which semantically matches it rather than reproducing it, since that fixture omits the field and setUnit merges an omitted `unitType` to the same \'normal\' (UNIT_DEFAULTS, data.js:110, spread at ui_state.js:362). rustAppliesToSpiritLinkedFantasticWarlord adds only `spiritLink` to a.abilities and reaches 7 because that cast clears the permanent Fantastic flag the targeting read sees.',
    },
  },
  rustAppliesToSpiritLinkedFantasticWarlord: {
    desc: 'Rust’s "regular unit" exclusion is a targeting restriction, and targeting reads the permanent record: Spirit Link’s cast clears the permanent Fantastic flag, which is the same effect its tail clear inside the recalculation (UnitCalc.CAS!NOTICEAGE!+2..+3 ": Effect of Sentience, enchanted fantastic unit could not be targeted by fantastic-only spell and gain +2 resistance :" "IF GETENCHANTMENTFLAG(U,EncSpiritLink,1) THEN { SETSTAT(U,AFantastic,0,0); }") describes — the unit "could not be targeted by fantastic-only spell". So a spirit-linked Chaos creature is a legal Rust target and takes the −3. Base atk 10 → 7, 100% hit, def 0 → 7 (without Rust, 10; without Spirit Link the permanent flag stands and Rust does not land, which rustFantasticUnaffectedWarlord pins at 10). The record choice is the contract ruling that spell targeting reads the permanent record, not a read of Warlord’s target-selection path, which is unreconstructed; this fixture pins the same 7 on either record, because the cast clears both.',
    version: V_WARLORD,
  ...
  divineProtectionLuckyToHitWarlord: {
    ...
    b: { def:0, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 0.4, sdDmgToB: 0.490 },
  },
  divineProtectionLuckyResistanceWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.0, sdDmgToB: 1.225 },
  },
  ...
  luckyStarAuraMeleeWarlord: {
    ...
    b: { def:0, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 0.6, sdDmgToB: 0.648 },
  },
  ...
  luckyStarEnchantedUnitWarlord: {
    ...
    b: { def:0, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 0.8, sdDmgToB: 0.693 },
  },
  luckyStarAuraResistanceWarlord: {
    ...
    expected: { dmgToA: 0.300, sdDmgToA: 0.458, dmgToB: 3.0, sdDmgToB: 1.225 },
  },
  luckyStarAuraArmorWarlord: {
    ...
    expected: { dmgToA: 0.300, sdDmgToA: 0.458, dmgToB: 1.0, sdDmgToB: 0.000 },
  },
  ...
  luckyStarAuraSkipsThrownAndBreathWarlord: {
    ...
    b: { def:0, hp:30 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 8.300, sdDmgToB: 0.458 },
  },
  luckyStarDoomGazeUnchangedWarlord: {
    ...
    b: { hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 5.300, sdDmgToB: 0.458 },
  },
  rallyResistanceWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 2.8, sdDmgToB: 1.296 },
  },
  disheartenProphecyResistanceWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 4.2, sdDmgToB: 1.296 },
  },
  ...
  rebuildDeathImmunityWarlord: {
    ...
    expected: { dmgToA: 0.600, sdDmgToA: 0.648, dmgToB: 0, sdDmgToB: 0.000 },
  },

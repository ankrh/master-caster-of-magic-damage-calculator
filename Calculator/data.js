...
const ABILITY_DEFS = [
  ...
  { key: 'deathTouch', label: 'Death Touch', type: 'numcheck', match: 'DeathTouch', group: 'Abilities', tooltip: 'For each attacker figure: Defender resist at −X or die.\nWarlord: Does not fire on ranged or magical ranged attacks.\nImmune: Death, Magic, Righteousness.' },
  ...
  { key: 'exorcise', label: 'Exorcise', type: 'numcheck', match: 'Exorcise', group: 'Abilities', tooltip: 'Fantastic targets only (the CoM successor to Dispel Evil).\nFor each attacker figure: Defender resist at −X or be banished.\nCreated-undead defenders suffer an additional −3.\nFires on melee, thrown, and ranged attacks.\nImmune: Magic, non-fantastic units.' },
...
const ENCHANTMENT_DEFS = [
  ...
  { key: 'resistanceToAll', label: 'Received res. to all', type: 'num', match: 'ResistanceToAll', group: 'Enchantments', subgroup: 'All versions', tooltip: '+X to resistance.' },
  { key: 'holyBonus', label: 'Received holy bonus', type: 'num', match: 'HolyBonus', group: 'Enchantments', subgroup: 'All versions', tooltip: '+X to melee attack, defense, and resistance.\nCoM 1 & 2: Also +X to ranged/thrown/breath attack.' },
  ...
  ...twoColumnMajor([
    { key: 'prayer', label: 'Prayer', type: 'bool', group: 'Enchantments', subgroup: '_All versions bools', realm: 'life', tooltip: '+10% To Hit, +10% To Block, +1 resistance.\nWarlord: Stacks with High Prayer (To Hit and To Block do not stack; adds +1 melee, +1 defense, +1 resistance on top).' },
    { key: 'highPrayer', label: 'High Prayer', type: 'bool', group: 'Enchantments', subgroup: '_All versions bools', realm: 'life', tooltip: '+10% To Hit, +10% To Block, +2 defense, +3 resistance.\nMoM 1.31 & 1.60, CoM 1: Also +3 melee.\nCoM 2 & Warlord: Also +2 melee.\nWarlord: Stacks with Prayer (see Prayer tooltip).' },
    ...
    { key: 'wraithForm', label: 'Wraith Form', type: 'bool', match: 'WraithForm', group: 'Enchantments', subgroup: '_All versions bools', realm: 'death', tooltip: 'Grants Weapon Immunity and Non-Corporeal to the unit. Attacks bypass enemy Weapon Immunity.' },
    ...
    { key: 'ccDefense', label: 'CC: +Defense', type: 'bool', group: 'Enchantments', subgroup: '_All versions bools', realm: 'chaos', tooltip: 'Chaos Channels (+Defense): Unit permanently becomes a fantastic Chaos creature.\n+3 defense.\nMoM 1.31 bug: Applied twice in combat (net +6).' },
    { key: 'ccFireBreath', label: 'CC: +Fire Breath', type: 'bool', group: 'Enchantments', subgroup: '_All versions bools', realm: 'chaos', tooltip: 'Chaos Channels (+Fire Breath): Unit permanently becomes a fantastic Chaos creature.\nMoM 1.31 & 1.60: Fire Breath strength 2.\nCoM 1 & 2: Fire Breath strength 4.\nReplaces any existing fire breath.\nWarlord: Stacks additively with existing fire breath instead of replacing.' },
    { key: 'ccFlight', label: 'CC: +Flight', type: 'bool', group: 'Enchantments', subgroup: '_All versions bools', realm: 'chaos', tooltip: 'Chaos Channels (+Flight): Unit permanently becomes a fantastic Chaos creature.\nFlight itself has no consequences in this calculator.' },
  ...
  ...twoColumnMajor([
    { key: 'guardian', label: 'Guardian retort', type: 'bool', match: 'Guardian', group: 'Enchantments', subgroup: 'CoM, CoM2 & Warlord', tooltip: '+1 resistance, +10% To Hit, and +10% To Defend.' },
    { key: 'tactician', label: 'Tactician retort', type: 'bool', match: 'Tactician', group: 'Enchantments', subgroup: 'CoM, CoM2 & Warlord', tooltip: 'CoM & CoM2: Non-hero units gain +1 defense.\nHero units gain +2 defense, +2 resistance, and +2 to all attack strengths.\nWarlord: All units gain +1 defense (no hero distinction).\nTeleporting units gain First Strike.\nNon-Corporeal units gain Negate First Strike.' },
    { key: 'supremeLight', label: 'Supreme Light', type: 'bool', match: 'SupremeLight', group: 'Enchantments', subgroup: 'CoM, CoM2 & Warlord', realm: 'life', tooltip: 'Applies only to Life fantastic creatures and Caster units.\n+2 melee and +2 ranged attack. Defense bonus = floor(resistance / 3).' },
    { key: 'endurance', label: 'Endurance', type: 'bool', match: 'Endurance', group: 'Enchantments', subgroup: 'CoM, CoM2 & Warlord', realm: 'life', tooltip: 'CoM 1: +2 defense.\nCoM 2: +floor(4 / figures) HP per figure, minimum +1 HP.' },
    { key: 'bloodLust', label: 'Blood Lust', type: 'bool', match: 'BloodLust', group: 'Enchantments', subgroup: 'CoM, CoM2 & Warlord', realm: 'death', tooltip: 'CoM/CoM2: Unit becomes undead (fantastic Death creature) and gains Death, Cold, Poison, and Illusion Immunity.\nWarlord: No longer turns the unit undead, no immunities granted.\nAll versions: Doubles melee attack against Normal and Hero targets.' },
  ...
  { key: 'powerMinerals', label: 'Natural Selection: Power minerals', type: 'num', match: 'PowerMinerals', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near power-mineral resources.\n+N Resistance.\nEnter the Resistance bonus directly.' },
  { key: 'survivalInstinctToBlock', label: 'Survival Instinct: +To Block%', type: 'num', match: 'SurvivalInstinctToBlock', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Survival Instinct (Warlord Nature very rare global).\nNewly trained normal units gain +3% to +7% To Defend from gold-producing resources near the city.\nApplies to normal units only.\nEnter the To Block bonus percentage directly.' },
  ...twoColumnMajor([
    ...
    { key: 'altarOfTheSun', label: 'Altar of the Sun (+fig)', type: 'bool', match: 'AltarOfTheSun', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Hawkmen units gain +1 Figure, except heroes.\nHoly Mother gains +1 Melee instead of the figure.\nThe defending-city High Prayer buff is not included.' },
    ...
    { key: 'fortification', label: 'Fortification', type: 'bool', match: 'Fortification', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'City building: all defending units inside city walls gain Large Shield.\n+3 defense vs ranged, thrown, and breath attacks.\nIf the unit already has Large Shield, it gains Missile Immunity instead.' },
    ...
    { key: 'plague', label: 'Plague', type: 'bool', match: 'Plague', group: 'Enchantments', subgroup: 'Warlord only', realm: 'death', tooltip: 'Warlord combat curse.\nApplied to defending garrison units by the Pestilence city curse,\nby the Plague Lord unit ability, and by the Plague Lord artifact power.\n−3 Attack, −3 Defense, −6 Resistance, −10% To Hit for the rest of combat.\nAffects all units (no fantastic exclusion).' },
    ...
    { key: 'coal', label: 'Natural Selection: Coal', type: 'bool', match: 'NaturalSelectionCoal', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near coal.\n+1 melee attack.' },
    { key: 'iron', label: 'Natural Selection: Iron', type: 'bool', match: 'NaturalSelectionIron', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near iron.\n+1 armor.' },
    { key: 'wildGame', label: 'Natural Selection: Wild game', type: 'bool', match: 'NaturalSelectionWildGame', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near wild game.\n+1 ranged attack (missile, boulder, thrown).\nGrants Forester.' },
    { key: 'nightshade', label: 'Natural Selection: Nightshade', type: 'bool', match: 'NaturalSelectionNightshade', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near nightshade.\n+1 Resistance.' },
    ...
    { key: 'greatUnbinding', label: 'Great Unbinding', type: 'bool', match: 'GreatUnbinding', group: 'Enchantments', subgroup: 'Warlord only', realm: 'sorcery', tooltip: 'Warlord Sorcery Very Rare global enchantment.\nDebuffs opponent fantastic creatures for the rest of battle.\n−20% To Hit.\n−20% To Defend.\n−2 Resistance.\nNo effect on non-fantastic units.\nThe Confusion half of the spell is not modelled here.' },
  ]),
];
...
const PRESETS = {
  ...
  // Non-Goblin: −3 melee / −3 armor / −3 resistance, no To Hit. Goblin: −1 melee / −1 armor.
  ...
  goblinPoxGoblinResistanceUnaffectedWarlord: {
    desc: 'Pox Host (Warlord) on a GOBLIN defender: resistance is NOT reduced (Goblins take only −1 melee / −1 armor). Death Touch 0 vs res 5 → pFail 0.5 × 10 = 5.0. Melee atk 1 fully blocked by armor 4−1=3. (A non-Goblin would be res 2 → 8.0)',
    version: 'com2_warlord_1.5.12.5',
    poxHost: true,
    a: { atk:1, toHitMod:70, hp:10, abilities: { deathTouch: 0 } },
  ...
  flameBladeBoulderWarlord: {
    ...
    version: 'com2_warlord_1.5.12.5',
    a: { rtbType:'boulder', rtb:1, toHitRtbMod:70, hp:10, abilities: { flameBlade: true } },
    b: { hp:10 },
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, dmgToB: 1.000 },
  },
  ...
  flameBladeFireBreathWarlord: {
    ...
    version: 'com2_warlord_1.5.12.5',
    a: { atk:1, toHitMod:70, rtbType:'fire', rtb:1, toHitRtbMod:70, hp:10, abilities: { flameBlade: true } },
    b: { hp:10 },
    expected: { dmgToA: 0, dmgToB: 6.000 },
  },
  ...
  fieryFuryFlameBladeNoStack: {
    ...
    version: 'com2_warlord_1.5.12.5',
    a: { atk:1, toHitMod:70, hp:10, abilities: { fieryFury: true, flameBlade: true } },
    b: { hp:10 },
    expected: { dmgToA: 0, dmgToB: 4.000 },
  },

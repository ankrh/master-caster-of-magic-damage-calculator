...
const ENCHANTMENT_DEFS = [
  ...
  ...realmLinear([
    ...
    { key: 'trueSight', label: 'True Sight', type: 'bool', match: 'TrueSight', group: 'Enchantments', subgroup: '_All versions bools', realm: 'life', tooltip: 'Grants Illusion Immunity.\nWarlord: +5% ranged, thrown, and breath To-Hit.' },
    { key: 'bless', label: 'Bless', type: 'bool', match: 'Bless', group: 'Enchantments', subgroup: '_All versions bools', realm: 'life', tooltip: "+X defense vs Chaos/Death attacks and +X resistance vs Death Gaze,\nDeath Touch, Life Steal, Cause Fear, and Destruction.\nMoM 1.31 & 1.60: +3 defense, +3 resistance.\nDefense applies to Chaos/Death creature melee, fire/lightning\nbreath, magical Chaos ranged, Chaos/Death gazes, and Immolation.\nCoM 1: +5 defense, +5 resistance.\nDefense applies only to fire/lightning breath, Chaos/Death gazes\nand Immolation — not to melee, thrown or any ranged attack.\nCoM 2: +5 defense, +5 resistance.\nWarlord: +7 defense, +4 resistance.\nCoM 2 and Warlord defense applies to fire/lightning breath,\nImmolation, magical Chaos ranged, and thrown or physical ranged\nattacks from Chaos/Death creatures." },
  ...
  ...realmLinear([
    ...
    { key: 'alumniOfAcademy', label: 'Academy (Alumni)', type: 'bool', match: 'AlumniOfAcademy', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Versions: Warlord\nApplies only to Halfling Rocs or non-Mechanical Halfling units\nwith magical ranged attacks.\n+2 Figures.' },
    ...
    { key: 'radio', label: 'Radio', type: 'bool', match: 'Radio', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Outlander research reform, not a cast spell.\nRegular units and Sapiens summons gain +10% To-Hit,\n+10% To-Defend, and +1 Resistance in combat.' },
    { key: 'rocketry', label: 'Rocketry', type: 'bool', match: 'Rocketry', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Versions: Warlord\nEligible normal units with physical ranged, Thrown, or Fire\nBreath gain Blackpowder Weapon.\nIts combat effects are identical to Military Workshop.' },
    ...
    { key: 'temporalEngineering', label: 'Temporal Engineering', type: 'bool', match: 'TemporalEngineering', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Versions: Warlord\nPower Engine units gain Haste.\nSailing Power Engine units also gain Flying and Illusion Immunity.' },
    { key: 'uphillBattle', label: 'Uphill Battle (AI unit)', type: 'bool', match: 'UphillBattle', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Versions: Warlord\nCheck this for an AI-controlled unit fighting the human player.\n+10% To Hit, +10% To Defend, and +1 Resistance.' },
    { key: 'xenopsychology', label: 'Xenopsychology', type: 'bool', match: 'Xenopsychology', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Outlander research reform, not a cast spell.\nRegular units and Sapiens summons gain +1 Resistance in combat.' },
    { key: 'xenoveterinary', label: 'Xenoveterinary', type: 'bool', match: 'Xenoveterinary', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Outlander wizard only.\nFantastic creatures gain +10% To-Hit and +25% HP\n(minimum +1) in combat.\nArmorclad access through Obsolescence Rearmament is not modeled.' },
    { key: 'outlanderWizard', label: 'Outlander wizard', type: 'bool', match: 'OutlanderWizard', group: 'Enchantments', subgroup: 'Warlord only', tooltip: 'Owner is an Outlander wizard.\nRequired for every Outlander reform condition in this panel.' },
    { key: 'flameBladeWarlord', label: 'Flame Blade', type: 'bool', match: 'FlameBlade', group: 'Enchantments', subgroup: 'Warlord only', realm: 'arcane', tooltip: 'Versions: Warlord\nArcane unit ability, not a wizard spell.\nBypasses Weapon Immunity.\n+3 melee, +2 missile/thrown, +1 fire breath.\nStacks with Fiery Blade or Fiery Fury — shared bonuses do not double; the only added bonus is +1 fire breath.' },
    ...
    { key: 'luckyStar', label: 'Lucky Star aura', type: 'bool', match: 'LuckyStar', group: 'Enchantments', subgroup: 'Warlord only', realm: 'arcane', tooltip: 'Versions: Warlord\nSet when any friendly unit in the combat has Lucky Star.\nEvery friendly unit gains +1 melee, ranged, thrown, and breath attack.\n+1 Armor, +1 Resistance. Multiple copies do not stack.\nThe enchanted unit itself also gains Lucky — tick Lucky for it.' },
...
// anything not offered there cannot be selected. ui.js's normalizeGameVersion() maps
...
const PRESETS = {
  ...
  bloodLustFireBreathUndoubledCoM2: {
    desc: 'CoM2 Blood Lust leaves Fire Breath undoubled: breath 3 + doubled melee 1→2 = 5.0',
    version: V_COM2,
    a: { atk:1, rtbType:'fire', rtb:3, toHitMod:70, toHitRtbMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { hp:10, unitType:'normal' },
    expected: { dmgToA: 0, dmgToB: 5.000 },
  },
  bloodLustLightningBreathUndoubledWarlord: {
    desc: 'Warlord Blood Lust leaves Lightning Breath undoubled: breath 3 + doubled melee 1→2 = 5.0',
    version: V_WARLORD,
    a: { atk:1, rtbType:'lightning', rtb:3, toHitMod:70, toHitRtbMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { hp:10, unitType:'normal' },
    expected: { dmgToA: 0, dmgToB: 5.000 },
  },
  bloodLustPhysicalRangedUndoubledCoM2: {
    ...
    version: V_COM2,
    a: { rtbType:'missile', rtb:3, toHitRtbMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { hp:10, unitType:'normal' },
    rangedCheck: true,
    expected: { dmgToA: 0, dmgToB: 3.000 },
  },
  bloodLustMagicalRangedUndoubledWarlord: {
    desc: 'Warlord Blood Lust leaves magical ranged undoubled: magical shot 3 = 3.0',
    version: V_WARLORD,
    a: { rtbType:'magic_sorcery', rtb:3, toHitRtbMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { hp:10, unitType:'normal' },
    rangedCheck: true,
    expected: { dmgToA: 0, dmgToB: 3.000 },
  },
  bloodLustDoomGazeUndoubledCoM2: {
    desc: 'CoM2 Blood Lust leaves Doom Gaze undoubled: gaze 3 + doubled melee 1→2 = 5.0',
    version: V_COM2,
    a: { atk:1, toHitMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true, doomGaze: 3 } },
    b: { hp:10, unitType:'normal' },
    expected: { dmgToA: 0, dmgToB: 5.000 },
  },
  ...
  destructionSaveModifierCoM2: {
    ...
    version: V_COM2,
    a: { atk:1, toHitMod:70, hp:10, abilities: { destruction: -3 } },
    b: { figs:4, def:1, toBlkMod:70, res:5, hp:10 },
  ...
  destructionRangedMagicWarlord: {
    desc: 'Destruction still fires on magical ranged in Warlord — unlike Stoning/Death Touch, it has no ranged exclusion (Energy Cannon triggers it from a beam, and the Magician only attacks at range) → 0.5 x 40 = 20.0.',
    version: V_WARLORD,
    a: { rtbType:'magic_c', rtb:1, toHitRtbMod:70, hp:10, abilities: { destruction: 0 } },
    b: { figs:4, def:1, toBlkMod:70, res:5, hp:10 },
    rangedCheck: true, rangedDist: 1,
  ...
  weaponImmunityAfterMissileImmunityCoM2: {
    desc: 'EffectiveDefense order: Missile Immunity replaces the accumulated defense with 100, then Weapon Immunity adds 8. A 105-strength missile attack is therefore fully blocked (the previous 100-final chain leaked 5 damage).',
    version: V_COM2,
    a: { rtbType:'missile', rtb:105, toHitRtbMod:70, hp:10 },
    b: { def:0, toBlkMod:70, hp:20, abilities: { missileImmunity: true, weaponImmunity: true } },
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, dmgToB: 0 },
  },
  ...
  blazeOfGloryZeroesEnchantmentArmorWarlord: {
    ...
    version: V_WARLORD,
    a: { atk:4, def:10, toHitMod:70, toBlkMod:70, hp:20 },
    b: { atk:0, def:0, toHitMod:70, toBlkMod:70, hp:20,
  ...
  alumniOfAcademyRocsWarlord: {
    ...
    version: V_WARLORD,
    a: { figs:2, atk:1, toHitMod:70, hp:5, race:'Halfling', name:'Halfling Rocs', abilities: { alumniOfAcademy: true } },
    b: { atk:0, def:0, hp:20 },
    expected: { dmgToA: 0, dmgToB: 4.000 },
  },
  ...
  colossalStrengthScalesBuffedMeleeWarlord: {
    ...
    version: V_WARLORD,
    a: { atk:10, toHitMod:70, hp:10, abilities: { colossalStrength: true, lionheart: true } },
    b: { def:2, toBlkMod:70, hp:30 },
  ...
  colossalStrengthScalesAfterRustWarlord: {
    ...
    version: V_WARLORD,
    a: { atk:10, toHitMod:70, hp:10, abilities: { colossalStrength: true, rust: true } },
    b: { def:2, toBlkMod:70, hp:20 },
    expected: { dmgToA: 0, dmgToB: 8 },
  },
  colossalStrengthScalesBuffedRangedWarlord: {
    ...
    version: V_WARLORD,
    a: { rtbType:'missile', rtb:10, toHitRtbMod:70, hp:10, abilities: { colossalStrength: true, lionheart: true } },
    b: { def:2, toBlkMod:70, hp:30 },
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, dmgToB: 17 },
  },
  ...
  upgradedExplosiveFireWarlord: {
    desc: 'Rocketry + Explosive derives Upgraded Explosive: Fire Breath 3+4 doubles to 14; melee 1 plus Blackpowder Poison on both attacks brings the total to 17.0.',
    version: V_WARLORD,
    a: { atk:1, rtbType:'fire', rtb:3, toHitMod:70, toHitRtbMod:70, hp:10, abilities: { outlanderWizard: true, rocketry: true, explosive: true } },
    b: { def:0, toBlkMod:70, hp:20 },
    expected: { dmgToA: 0, dmgToB: 17.000 },
  },
  ...
  levelBonusAfterUpgradedExplosiveWarlord: {
    desc: 'The level ladder is @Units@ApplyLevelBonus in region c, so Upgraded Explosive\'s end-of-region-b doubling cannot see it: fire breath 4 + 4 workshop = 8, doubled to 16, then +2 champion = 18. Melee 1 + 4 champion = 5 is fully blocked by 5 defense, leaving 18 − 5 = 13 (doubling the levelled value would make the breath 20, for 15). The defender is Poison Immune so the Military Workshop poison rider does not add to the total.',
    version: V_WARLORD,
    a: { figs:1, atk:1, rtbType:'fire', rtb:4, level:'champion', toHitMod:70, toHitRtbMod:70, hp:20,

...
const ENCHANTMENT_DEFS = [
  ...
  ...realmLinear([
    ...
    { key: 'mislead', label: 'Mislead', type: 'bool', match: 'Mislead', group: 'Enchantments', subgroup: 'CoM2 & Warlord', exceptVersions: ['com2_warlord_'], realm: 'death', tooltip: '−1 melee attack, −1 ranged attack, −1 defense, −1 resistance.\nWarlord: renamed Liability (separate entry).' },
  ...
  { key: 'powerMinerals', label: 'Natural Sel.: Power minerals', type: 'num', match: 'PowerMinerals', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near power-mineral resources.\n+N Resistance.\nEnter the Resistance bonus directly.' },
  ...
  ...realmLinear([
    ...
    { key: 'coal', label: 'Natural Sel.: Coal', type: 'bool', match: 'NaturalSelectionCoal', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near coal.\n+1 melee attack.' },
    { key: 'iron', label: 'Natural Sel.: Iron', type: 'bool', match: 'NaturalSelectionIron', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near iron.\n+1 armor.' },
    { key: 'wildGame', label: 'Natural Sel.: Wild game', type: 'bool', match: 'NaturalSelectionWildGame', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near wild game.\n+1 ranged attack (missile, boulder, thrown).\nGrants Forester.' },
    { key: 'nightshade', label: 'Natural Sel.: Nightshade', type: 'bool', match: 'NaturalSelectionNightshade', group: 'Enchantments', subgroup: 'Warlord only', realm: 'nature', tooltip: 'Natural Selection (Warlord Nature common global).\nUnit trained near nightshade.\n+1 Resistance.' },

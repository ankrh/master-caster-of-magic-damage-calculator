...
definePresets({
  ...
  supernaturalFormulaCoM2: {
    ...
    version: V_COM2,
    a: { rtbType:'magic', rtb:28, toHitRtbMod:70, hp:10, abilities: { supernatural: true } },
  ...
  supernaturalMagicImmunityRangedCoM2: {
    ...
    version: V_COM2,
    a: { rtbType:'magic', rtb:6, toHitRtbMod:70, hp:10, abilities: { supernatural: true } },
  ...
  fieryFuryUndeadNoChaosConversion: {
    ...
    version: V_WARLORD,
    chaosSurge: 1,
    a: { atk:1, toHitMod:70, hp:10, unitType:'fantastic_death', abilities: { fieryFury: true, undead: true } },
    b: { hp:10 },
    expected: { dmgToA: 0, dmgToB: 1.000 },
  },
  fieryFurySanctifyNoChaosConversionWarlord: {
    ...
    version: V_WARLORD,
    chaosSurge: 1,
    a: { atk:1, toHitMod:70, hp:10, unitType:'fantastic_nature', abilities: { fieryFury: true, sanctify: true } },
    b: { hp:10 },
    expected: { dmgToA: 0, dmgToB: 1.000 },
  },

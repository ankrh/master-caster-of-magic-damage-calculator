...
const TEST_TREE = [
  {
    ...
    subs: [
      ...
      { name: 'Heavenly Light', keys: ['heavenlyLightRangedCoM2', 'heavenlyLightNotBreathCoM2'] },
  ...
  { name: 'Version differences tests', subs: [
      ...
      { name: 'Immolation', keys: ['immolationRangedMoM', 'immolationNotRangedPatched', 'immolationNotRangedCoM', 'immolationMoMStrength', 'immolationCoMStrength10'] },

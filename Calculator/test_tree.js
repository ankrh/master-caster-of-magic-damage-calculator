...
const TEST_TREE = [
  {
    ...
    subs: [
      ...
      { name: 'Discipline', keys: ['combatDisciplineEliteNegatesFirstStrikeCoM2', 'disciplineCastPrecedesDestinyCoM2', 'disciplineCastReachesHeroWarlord', 'disciplineCastRefusedOnHeroCoM2', 'disciplineCastRefusedOnPermanentFantasticCoM2', 'disciplineCastRefusedOnPermanentFantasticWarlord', 'overlandDisciplineDefenseNormalCoM2', 'overlandDisciplineDefenseRegularCoM2', 'overlandDisciplineVeteranMeleeCoM2', 'overlandDisciplineVeteranMagicRangedNoBonusCoM2', 'overlandDisciplineVeteranMissileCoM2'] },

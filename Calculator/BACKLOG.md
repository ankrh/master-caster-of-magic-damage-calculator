...
| # | Items | Next outcome |
|---|---|---|
| 1 | **R9-G1k** | Close the independent resolution provenance domain. |
| 2 | **R9-G1i** | Bind the remaining Wall of Fire strength formula to D22's source-shaped record. |
...
| R9-G1i | Close the remaining `wallOfFireStrength` gap for the inherited DOS Fireball strength. Versions: evidence/builds — MoM 1.31 `SPELLDAT.LBX`, MoM CP 1.60 `SPELLDAT.LBX`; calculator — `mom_1.31`, `mom_cp_1.60.00`. | small | Seven effective-attack, defense and damage-constant formulas closed in [HISTORY.md](./HISTORY.md); D22's reviewed source-shaped record is complete |

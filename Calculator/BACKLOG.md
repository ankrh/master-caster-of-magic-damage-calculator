...
| # | Items | Next outcome |
|---|---|---|
| 1 | **R7.4** | Expose the completed binary-order modifier traces from the existing single-value display. |

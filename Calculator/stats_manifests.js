...
const CHAIN_MOM_1_31 = versionChain('mom_1.31', [
  ...
  'a:identity:legacyConversions', 'a:holyBonus', 'a:resistanceToAll',
  'a:chaosChannels:fireBreath',
  'c:level', 'c:lucky', 'c:weapon', 'c:chance:weapon:melee', 'c:chance:weapon:rtb',
  'c:chaosSurge', 'c:chance:holyWeapon:melee', 'c:chance:holyWeapon:rtb', 'c:blackChannels',
  'c:ironSkin', 'c:stoneSkin', 'c:flameBlade', 'c:flameBlade:ranged', 'c:giantStrength',
  'c:giantStrength:thrown', 'c:chaosChannels:armor', 'c:lionheart', 'c:lionheart:rangedHp',
  'c:holyArmor', 'c:berserk', 'c:nodeAura', 'c:highPrayer', 'c:prayer', 'c:trueLight',
  'c:darkness', 'c:metalFires', 'c:chance:warpReality', 'c:blackPrayer', 'c:chance:vertigo',
  'c:weakness', 'c:weakness:ranged', 'c:mindStorm', 'c:warpAttack', 'c:warpDefense',
  'c:warpResist', 'c:shatter', 'c:charmOfLife',
...
const CHAIN_MOM_CP_1_60 = versionChain('mom_cp_1.60.00', [
  ...
  'a:chaosChannels:fireBreath',
  'c:level', 'c:lucky', 'c:weapon', 'c:chance:weapon:melee', 'c:chance:weapon:rtb',
  'c:chaosSurge', 'c:blackChannels', 'c:ironSkin', 'c:stoneSkin', 'c:flameBlade',
  'c:flameBlade:ranged', 'c:giantStrength', 'c:giantStrength:thrown', 'c:chaosChannels:armor',
  'c:lionheart', 'c:lionheart:rangedHp', 'c:holyArmor', 'c:berserk', 'c:chance:holyWeapon:melee',
  'c:chance:holyWeapon:rtb', 'c:nodeAura', 'c:highPrayer', 'c:prayer', 'c:trueLight',
  'c:darkness', 'c:metalFires', 'c:chance:warpReality', 'c:blackPrayer', 'c:chance:vertigo',
  'c:weakness', 'c:weakness:ranged', 'c:mindStorm', 'c:warpAttack', 'c:warpDefense',
  'c:warpResist', 'c:shatter', 'c:charmOfLife',
  'e:chance:legacyClamp', 'e:clamp',
...
const CHAIN_COM_6_08 = versionChain('com_6.08', [
  'base:identity:zombies', 'base:identity:com1ConstructCatapult',
  'base:identity:com1SummonBranch', 'base:stat:base', 'base:chance:baseMelee',
  'base:chance:baseRtb', 'base:chance:baseBlock', 'base:identity:zombies:toBlock',
  'a:identity:legacyConversions', 'a:holyBonus', 'a:resistanceToAll',
  'a:chaosChannels:fireBreath',
  'c:level', 'c:lucky', 'c:weapon', 'c:chance:weapon:melee', 'c:chance:weapon:rtb',
  'c:endurance', 'c:animated', 'c:flameBlade', 'c:flameBlade:ranged', 'c:lionheart',
  'c:lionheart:rangedHp', 'c:ironSkin', 'c:chaosChannels:armor', 'c:landLinking',
  'c:landLinking:breath', 'c:mysticSurge', 'c:holyArmor', 'c:focusMagic',
  'c:focusMagic:conversion', 'c:orihalcon', 'c:chance:holyWeapon:melee',
  'c:chance:holyWeapon:rtb', 'c:chaosSurge', 'c:survivalInstinct', 'c:nodeAura', 'c:highPrayer',
  'c:prayer', 'c:blazingMarch', 'c:blazingMarch:ranged', 'c:chance:warpReality', 'c:blackPrayer',
  'c:guardian', 'c:guidingBeaconAura:coM1', 'c:divineBarrierAura:coM1', 'c:soulLinkerAura:coM1',
  'c:chance:vertigo', 'c:weakness', 'c:weakness:ranged', 'c:mindStorm', 'c:warpAttack',
  'c:warpDefense', 'c:warpResist', 'c:shatter', 'c:darkness', 'c:supremeLight:coM1',
  'c:realmWard', 'c:tactician:coM1', 'c:eternalNight:enemyResistance', 'c:charmOfLife',
  'e:chance:legacyClamp', 'e:clamp',
]);

const CHAIN_COM2_1_05_11 = versionChain('com2_1.05.11', [
  'base:stat:base', 'base:chance:baseMelee', 'base:chance:baseRtb', 'base:chance:baseBlock',
  'a:identity:combatSummoned', 'a:identity:chosen', 'a:identity:constructCatapult',
  'a:identity:callToArmsPaladins', 'a:identity:legacyConversions', 'a:chaosChannels:fireBreath',
  'c:destiny', 'c:level', 'c:focusMagic', 'c:focusMagic:conversion', 'c:lucky', 'c:darkForce',
  'c:heavenlyLight', 'c:chance:heavenlyLight:melee', 'c:chance:heavenlyLight:rtb', 'c:weapon',
  'c:chance:weapon:melee', 'c:chance:weapon:rtb', 'c:endurance', 'c:discipline',
  'c:chaosChannels:armor', 'c:animated', 'c:flameBlade', 'c:flameBlade:ranged', 'c:mysticSurge',
  'c:lionheart', 'c:lionheart:rangedHp', 'c:ironSkin', 'c:landLinking', 'c:landLinking:breath',
  'c:holyArmor', 'c:orihalcon', 'c:chance:holyWeapon:melee', 'c:chance:holyWeapon:rtb',
  'c:chaosSurge', 'c:survivalInstinct', 'c:innerPower', 'c:reinforceMagic',
  'c:reinforceMagic:ranged', 'c:eternalNight:enemyResistance', 'c:charmOfLife', 'c:nodeAura',
  'c:badMoon', 'c:goodMoon', 'c:natureConjunction', 'c:highPrayer', 'c:prayer', 'c:blazingMarch',
  'c:blazingMarch:ranged', 'c:breakthrough:normal', 'c:breakthrough:noncorporeal',
  'c:breakthrough:combatSummoned', 'c:chance:warpReality', 'c:blackPrayer', 'c:darkness',
  'c:guardian', 'c:chance:vertigo', 'c:weakness', 'c:weakness:ranged', 'c:mindStorm',
  'c:warpAttack', 'c:warpDefense', 'c:warpResist', 'c:shatter', 'c:spellWard', 'c:tactician',
  'e:chance:modernClampCommon', 'e:chance:clamp', 'e:clamp', 'e:holyBonus:aura',
  'e:guidingBeaconAura', 'e:resistanceToAll:aura', 'e:divineBarrierAura', 'e:soulLinkerAura',
  'e:leadershipAura', 'e:mislead', 'e:supremeLight',
]);
...
const CHAIN_COM2_WARLORD_1_5_12_7 = versionChain('com2_warlord_1.5.12.7', [
  ...
  'base:energyCannon', 'base:chance:survivalInstinctToBlock',
  'a:identity:combatSummoned', 'a:identity:chosen', 'a:identity:constructCatapult',
  'a:identity:callToArmsPaladins', 'a:identity:legacyConversions', 'a:chaosChannels:fireBreath',
  'b:identity:marionetteChanneler', 'b:marionette:stats', 'b:marionette:strayedTransmute',
  'b:rebuild', 'b:tactician:warlordClawback', 'b:fieryFury', 'b:natureLink',
  ...
  'b:battleArmor', 'b:chance:nausea', 'b:uphillBattle', 'b:soulFlay',
  'b:eternalNight:poorVision', 'b:greatUnbinding', 'b:prayer:warlordStack', 'b:rally',
  'b:trueLight', 'b:plague', 'b:goblinPox', 'b:luckyStar', 'b:disheartenProphecy',
  'b:wallOfFire:garrison', 'b:godsPlayDices',
  'c:destiny', 'c:level', 'c:focusMagic', 'c:focusMagic:conversion', 'c:lucky', 'c:darkForce',
  'c:heavenlyLight', 'c:chance:heavenlyLight:melee', 'c:chance:heavenlyLight:rtb', 'c:weapon',
  'c:chance:weapon:melee', 'c:chance:weapon:rtb', 'c:endurance', 'c:discipline',
  'c:chaosChannels:armor', 'c:animated', 'c:flameBlade', 'c:flameBlade:ranged', 'c:mysticSurge',
  ...
  'c:guardian', 'c:chance:vertigo', 'c:weakness', 'c:weakness:ranged', 'c:mindStorm',
  'c:warpAttack', 'c:warpDefense', 'c:warpResist', 'c:shatter', 'c:spellWard', 'c:tactician',
  'd:mechanicalExpert', 'd:weakness:breath', 'd:chance:trueSight:ranged',
  'd:flameBlade:fireBreath', 'd:chance:berserkWarlord', 'd:rust', 'd:chance:hurricane',
  'd:favoredTerrain', 'd:colossalStrength', 'd:vampirism:transfer', 'd:shadowStrike:thrown',
  'd:identity:spiritLink', 'd:psychoForce', 'd:pneumaField', 'd:chance:energyCannonThreshold',
  'd:blazeOfGlory', 'd:blazeOfGlory:thrown', 'd:beatOfSwiftness', 'd:hierophany',
  'e:chance:modernClampCommon', 'e:chance:clamp', 'e:clamp', 'e:holyBonus:aura',
  'e:guidingBeaconAura', 'e:resistanceToAll:aura', 'e:divineBarrierAura', 'e:soulLinkerAura',
  'e:leadershipAura', 'e:mislead', 'e:supremeLight',
]);

...
definePresets({
  ...
  bloodLustMagicalRangedUndoubledWarlord: {
    desc: 'Warlord Blood Lust leaves magical ranged undoubled: a Magic(S) shot of 3 stays 3.0 where the doubling would make it 6.0. The attack type token is magic_s — the spelled-out magic_sorcery this preset used before is in no type list (data.js:37-39), so the unit had no attack at all and the preset could never fail.',
    version: V_WARLORD,
    a: { rtbType:'magic_s', rtb:3, toHitRtbMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { hp:10, unitType:'normal' },
    rangedCheck: true,
    expected: { dmgToA: 0, dmgToB: 3.000 },
  },
  ...
  bloodLustVulnerableToExorciseCoM2: {
    ...
    version: V_COM2,
    a: { atk:1, toHitMod:70, hp:10, abilities: { exorcise: -6 } },

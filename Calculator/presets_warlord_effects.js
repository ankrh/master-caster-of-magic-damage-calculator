...
definePresets({
  ...
  bloodLustMagicalRangedUndoubledWarlord: {
    ...
    version: V_WARLORD,
    a: { rtbType:'magic', rtb:3, toHitRtbMod:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { hp:10, unitType:'normal' },
    rangedCheck: true,
    expected: { dmgToA: 0, dmgToB: 3.000 },
  },
  ...
  revenantDeathTouchNotRangedWarlord: {
    ...
    version: V_WARLORD,
    a: { rtbType:'magic', rtb:1, toHitRtbMod:70, hp:10, abilities: { revenant: true } },
    b: { def:1, toBlkMod:70, res:5, hp:10 },
    rangedCheck: true, rangedDist: 1,
  ...
  destructionRangedMagicCoM2: {
    ...
    version: V_COM2,
    a: { rtbType:'magic', rtb:1, toHitRtbMod:70, hp:10, abilities: { destruction: 0 } },
    b: { figs:4, def:1, toBlkMod:70, res:5, hp:10 },
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, dmgToB: 20.000 },
  },
  ...
  naturalSelectionWildGameMagicRangedWarlord: {
    ...
    version: V_WARLORD,
    a: { figs:1, rtbType:'magic', rtb:5, toHitRtbMod:70, hp:10, abilities: { wildGame: true } },
    b: { def:0, toBlkMod:70, hp:20 },
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, dmgToB: 6.000 },
  },
  ...
  hierophanyStripsMagicImmunityWarlord: {
    ...
    version: V_WARLORD,
    a: { rtbType:'magic', rtb:3, toHitRtbMod:70, hp:10 },

...
definePresets({
  ...
  berserkWarlordPlus15ToHit: {
    ...
    b: { def:0, hp:20 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 1.800, sdDmgToB: 0.995 },
  },
  ...
  temporalTwistBypassesMagicImmunity: {
    desc: 'Temporal Twist bypasses Magic Immunity: the Warlord block gates on the side-wide CGTemporalTwist combat global and carries no per-unit flag and no immunity term, so there is no roll for the immunity to refuse. A loses First Strike and B retaliates (dmgToA=5)',
    version: V_WARLORD,
    ...
    vacuity: {
      'a.ability.magicImmunity':
        'Keep, and the absence of its effect is the rule under test: the immunity must not reach Temporal Twist, so ablating it changes nothing. It did until 2026-09-03, when `temporalTwist` left MAGIC_IMMUNITY_GATED_CURSES — before that the strip cleared the Twist here, First Strike stood and dmgToA was 0. a.ability.temporalTwist is the live half: ablating it leaves First Strike in place and A kills B before the counter. The sibling assertion for a combat global that was never gated is blackPrayerBypassesMagicImmunity.',
      'a.ability.firstStrike':
        'Keep. Inert as a consequence of the assertion, exactly as in temporalTwistStripsFirstStrikeWarlord: applyTemporalTwistEffects deletes the flag before the melee gate reads it, so removing it from the fixture as well changes nothing.',
    },
  },
  ...
  bloodLustBypassesWeaponImmunityCoM2: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 9.400, sdDmgToB: 0.648 },
    vacuity: {
  ...
  bloodLustDoesNotBypassWeaponImmunityWarlord: {
    ...
    a: { atk:5, hitChance:70, hp:10, unitType:'normal', abilities: { bloodLust: true } },
    b: { def:2, hp:10, abilities: { weaponImmunity: true } },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 6.400, sdDmgToB: 1.587 },
  },
  ...
  bloodsuckerCapAtRemHPWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 6, sdDmgToB: 0.000, regDmgToB: 7.000, sdRegDmgToB: 0.000 },
    vacuity: {
      'name-binds-nothing':
  ...
  bloodsuckerCounterAttackWarlord: {
    ...
    expected: { dmgToA: 5.000, sdDmgToA: 0.000, dmgToB: 1.000, sdDmgToB: 0.000 },
    vacuity: {
      'name-binds-nothing':
  ...
  revenantGrantsDeathTouchWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 5.000, sdDmgToB: 5.000 },
  },
  revenantDeathTouchOnThrownWarlord: {
    ...
    b: { def:1, toBlkMod:70, res:5, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 7.500, sdDmgToB: 4.330 },
  },
  ...
  revenantGrantsUndeadImmunityWarlord: {
    ...
    expected: { dmgToA: 10.000, sdDmgToA: 0.000, dmgToB: 0, sdDmgToB: 0.000 },
  },
  ...
  destructionWholeUnitCoM2: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 20.000, sdDmgToB: 20.000, regDmgToB: 0.000, sdRegDmgToB: 0.000, irrDmgToB: 75.000, sdIrrDmgToB: 75.000 },
  },
  destructionPerAttackerFigureCoM2: {
    ...
    b: { figs:4, def:1, toBlkMod:70, res:5, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 37.500, sdDmgToB: 9.682, regDmgToB: 0.000, sdRegDmgToB: 0.000, irrDmgToB: 140.625, sdIrrDmgToB: 36.309 },
  },
  destructionSaveModifierCoM2: {
    ...
    b: { figs:4, def:1, toBlkMod:70, res:5, hp:10 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 32.000, sdDmgToB: 16.000, regDmgToB: 0.000, sdRegDmgToB: 0.000, irrDmgToB: 120.000, sdIrrDmgToB: 60.000 },
  },
  ...
  destructionBlessCoM2: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 12.000, sdDmgToB: 18.330, regDmgToB: 0.000, sdRegDmgToB: 0.000, irrDmgToB: 45.000, sdIrrDmgToB: 68.739 },
  },
  destructionBlessWarlord: {
    ...
    a: { atk:1, hitChance:70, hp:10, abilities: { destruction: 0 } },
    b: { figs:4, def:1, toBlkMod:70, res:2, hp:10, abilities: { bless: true } },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 16.000, sdDmgToB: 19.596, regDmgToB: 0.000, sdRegDmgToB: 0.000, irrDmgToB: 60.000, sdIrrDmgToB: 73.485 },
  },
  ...
  shadowStrikeBoostsExistingThrownWarlord: {
    ...
    b: { def:0, toBlkMod:70, hp:20 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 17.000, sdDmgToB: 0.000 },
  },
  ...
  shadowStrikeDoublePoisonWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 16.600, sdDmgToB: 1.200 },
  },
  ...
  soulFlayResistanceRecruitWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 7.000, sdDmgToB: 4.583 },
  },
  ...
  plagueMeleeWarlord: {
    ...
    b: { def:0, toBlkMod:70, hp:20 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 4.500, sdDmgToB: 0.671 },
  },
  plagueRangedWarlord: {
  ...
  greatUnbindingToBlockWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 2.000, sdDmgToB: 1.265 },
  },
  greatUnbindingResistanceWarlord: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 7.000, sdDmgToB: 4.582 },
  },
  ...
  naturalSelectionCoalCreatesMeleeWarlord: {
    ...
    expected: { dmgToA: 1.000, sdDmgToA: 0.000, dmgToB: 5.000, sdDmgToB: 0.000 },
  },
  naturalSelectionCoalOpensHolyBonusWarlord: {
    ...
    expected: { dmgToA: 3.000, sdDmgToA: 0.000, dmgToB: 3.000, sdDmgToB: 0.000 },
  },
  ...
  blazeOfGloryCarriesNoBombsGrenadesGrantWarlord: {
    ...
    b: { def:0, toBlkMod:70, hp:40 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 14.000, sdDmgToB: 0.000 },
  },
  blazeOfGloryThrownReadsHolyWeaponToHitWarlord: {
    ...
    b: { def:0, toBlkMod:70, hp:30 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 4.800, sdDmgToB: 1.697 },
  },
  ...
  blackChannelsDefBonus: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.700, sdDmgToB: 0.458 },
  },
  blackChannelsResBonus: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 5.500, sdDmgToB: 5.500, regDmgToB: 0.000, sdRegDmgToB: 0.000, irrDmgToB: 5.500, sdIrrDmgToB: 5.500 },
  },
  ...
  blackChannelsDeathImmune: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 2.700, sdDmgToB: 0.458 },
  },

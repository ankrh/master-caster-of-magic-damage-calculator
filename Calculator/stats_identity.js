...
function permanentCastFlagSteps(version, marked) {
  ...
  return [
    // PROVENANCE[trueSight:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 establishes the BaseUnits combat-layer store consistent with modern True Sight index 41. Normal overland producer, runtime binding, full admission and flag-layer equivalence remain open. Any further post-store reconstruction needs a specific unanswered claim. DOS consumer reconstruction exists, but the direct named writer remains unlocated in reviewed canonical sources. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md

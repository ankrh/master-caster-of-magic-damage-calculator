...
// Combat_Effects store, and F250.2 maps modern combat stores; neither verifies this destination.
...
function curseCastSteps(version, marked, eyeOfHeaven) {
  ...
  const cast = key => ({ sourceId: key, sourceLabel: CURSE_CAST_LABELS[key], writes: [key],
    ...
    apply: u => { u[key] = true; } });
  return [
    // PROVENANCE[weakness:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit reconstructs modern generic combat-layer stores. INI-to-runtime field loading, complete named admission, scripts remain open, so this permanent-record step is not verified. DOS A32 owns the generic class13/16 battle store, and named binding remains open. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'weakness:cast', phase: 'debuffs', ...cast('weakness') }),
    // PROVENANCE[blackSleep:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit reconstructs modern generic combat-layer stores. INI-to-runtime field loading, complete named admission, scripts remain open, so this permanent-record step is not verified. DOS A32 owns the generic class13/16 battle store, and named binding remains open. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'blackSleep:cast', phase: 'debuffs', ...cast('blackSleep') }),
    // PROVENANCE[shatter:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit reconstructs modern generic combat-layer stores. INI-to-runtime field loading, complete named admission, scripts remain open, so this permanent-record step is not verified. DOS A32 already proves Shatter writes battle Combat_Effects, while the permanent-record implementation remains unverified. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'shatter:cast', phase: 'debuffs', ...cast('shatter') }),
    // PROVENANCE[vertigo:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit reconstructs modern generic combat-layer stores. INI-to-runtime field loading, complete named admission, scripts remain open, so this permanent-record step is not verified. DOS A32 owns the generic class13/16 battle store, and named binding remains open. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'vertigo:cast', phase: 'debuffs', ...cast('vertigo') }),
    // PROVENANCE[warpAttack:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit maps WarpCreatureEffect to combat-layer indices 6/7/8. Caller admission, later scripts, persistence remain open, so this permanent-record step is not verified. DOS consumer reconstruction exists, but the direct named writer remains unlocated in reviewed canonical sources. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'warpAttack:cast', phase: 'debuffs', ...cast('warpAttack') }),
    // PROVENANCE[warpDefense:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit maps WarpCreatureEffect to combat-layer indices 6/7/8. Caller admission, later scripts, persistence remain open, so this permanent-record step is not verified. DOS consumer reconstruction exists, but the direct named writer remains unlocated in reviewed canonical sources. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'warpDefense:cast', phase: 'debuffs', ...cast('warpDefense') }),
    // PROVENANCE[warpResist:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit maps WarpCreatureEffect to combat-layer indices 6/7/8. Caller admission, later scripts, persistence remain open, so this permanent-record step is not verified. DOS consumer reconstruction exists, but the direct named writer remains unlocated in reviewed canonical sources. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'warpResist:cast', phase: 'debuffs', ...cast('warpResist') }),
    // PROVENANCE[mindStorm:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit reconstructs modern generic combat-layer stores. INI-to-runtime field loading, complete named admission, scripts remain open, so this permanent-record step is not verified. DOS consumer reconstruction exists, but the direct named writer remains unlocated in reviewed canonical sources. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
...
function permanentCastFlagSteps(version, marked) {
  ...
  return [
    // PROVENANCE[trueSight:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 first combat subunit reconstructs the generic combat-region store consistent with modern True Sight index 41. Overland store, later combat continuation, runtime loading, complete admission remain open, so the permanent-record cast assumption is not verified. DOS consumer reconstruction exists, but the direct named writer remains unlocated in reviewed canonical sources. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md

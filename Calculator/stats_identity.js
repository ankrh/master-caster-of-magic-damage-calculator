...
// Modern group/index assignments and selected continuations are mapped in F250.2. Runtime
// installation conditions, DOS binding and named Illusion caller/flag binding remain separate.
...
function curseCastSteps(version, marked, eyeOfHeaven) {
  ...
  const cast = key => ({ sourceId: key, sourceLabel: CURSE_CAST_LABELS[key], writes: [key],
    ...
    apply: u => { u[key] = true; } });
  return [
    // PROVENANCE[weakness:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 establishes modern BaseUnits.CombatEnchantmentFlags stores and existing recalculation copies/aggregates that layer. Local modern group/index assignments and selected call order are known. Runtime installation, named admission and equivalence to this undifferentiated flag step remain open. DOS A32 owns the generic class13/16 battle store, and named binding remains open. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
    statStep({ id: 'weakness:cast', phase: 'debuffs', ...cast('weakness') }),
    // PROVENANCE[blackSleep:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 establishes modern BaseUnits.CombatEnchantmentFlags stores and existing recalculation copies/aggregates that layer. Local modern group/index assignments and selected call order are known. Runtime installation, named admission and equivalence to this undifferentiated flag step remain open. DOS A32 owns the generic class13/16 battle store, and named binding remains open. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md
...
function permanentCastFlagSteps(version, marked) {
  ...
  return [
    // PROVENANCE[trueSight:cast]: UNVERIFIED versions=mom_1.31,mom_cp_1.60.00,com_6.08,com2_1.05.11,com2_warlord_1.5.12.9; gap=F250.2 establishes BaseUnits combat and overland-layer stores consistent with modern True Sight index 41. See Reference docs/Caster binary/F250.2.overland-store.evidence.md. Modern local group/index assignments and combat/overland continuation order are known. Runtime installation, full admission and flag-layer/pass equivalence remain open. See Reference docs/Caster binary/F250.2.truesight-continuation.evidence.md. DOS F250.3 reconstructs distinct battle-enchantment and overland _UNITS.enchantments writers, including the conditional CoM1 Status clear. Named runtime binding, enclosing timing and full-pass equivalence remain conditional. See Reference docs/DOS reconstructed/F250.3.reconciliation.md.; pointer=Reference docs/Caster binary/F250.2.combat.evidence.md

...
definePresets({
  ...
  weaponImmunityAfterMissileImmunityCoM2: {
    ...
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 27.100, sdDmgToB: 4.419 },
  },
  ...
  fireImmunityAfterArmorPiercing: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 20.000, sdDmgToB: 0.000 },
    vacuity: {
  ...
  fearBasic: {
    ...
    expected: { dmgToA: 1.500, sdDmgToA: 1.500, dmgToB: 10.500, sdDmgToB: 1.500 },
  },
  fearDefenderNoop: {
  ...
  illusionImmunityNegates: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 0.449, sdDmgToB: 0.790 },
    vacuity: {
      'a.ability.illusion':
  ...
  trueSightRangedToHitWarlord: {
    ...
    b: { atk:0, def:0, hp:10 },
    rangedCheck: true, rangedDist: 1,
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 0.350, sdDmgToB: 0.477 },
  },
  ...
  cityWallsProtectsInitiatorOnCounterattackCoM2: {
    ...
    expected: { dmgToA: 1.000, sdDmgToA: 0.000, dmgToB: 4.000, sdDmgToB: 0.000 },
  },
  cityWallsProtectsRecipientAcrossWallCoM2: {
    ...
    expected: { dmgToA: 4.000, sdDmgToA: 0.000, dmgToB: 1.000, sdDmgToB: 0.000 },
  },
  cityWallsNoBonusWhenBothInsideCoM2: {
    ...
    a: { atk:4, def:0, hitChance:70, toBlkMod:70, hp:20, cityWalls:'3' },
    b: { atk:4, def:0, hitChance:70, toBlkMod:70, hp:20, cityWalls:'3' },
    expected: { dmgToA: 4.000, sdDmgToA: 0.000, dmgToB: 4.000, sdDmgToB: 0.000 },
  },
  ...
  invisibilityMelee: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 1.000, sdDmgToB: 0.894 },
  },
  ...
  invisibilityCounter: {
    ...
    b: { atk:5, def:0, hp:10 },
    expected: { dmgToA: 1.000, sdDmgToA: 0.894, dmgToB: 0.300, sdDmgToB: 0.458 },
  },
  ...
  destinyResistanceAndHpCoM2: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 6.000, sdDmgToB: 9.165 },
  },
  ...
  guardianToDefendCoM2: {
    ...
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 4.600, sdDmgToB: 0.490 },
  },
  ...
  favoredTerrainToHitWarlord: {
    ...
    b: { def:0, atk:0, hp:20 },
    expected: { dmgToA: 0, sdDmgToA: 0.000, dmgToB: 3.500, sdDmgToB: 1.508 },
  },

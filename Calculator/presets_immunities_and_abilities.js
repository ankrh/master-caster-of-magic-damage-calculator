...
definePresets({
  ...
  weaponImmunityAfterMissileImmunityCoM2: {
    ...
    version: V_COM2,
    a: { rtbType:'missile', rtb:70, toHitRtbMod:70, hp:10 },
  ...
  destinyFireBreathDoublesCoM2: {
    ...
    version: V_COM2,
    a: { atk:0, rtbType:'fire', rtb:3, toHitRtbMod:70, hp:10, abilities: { destiny: true } },
    b: { def:0, hp:30 },
    expected: { dmgToA: 0, dmgToB: 6.000 },
  },
  destinyLightningBreathDoublesCoM2: {
    ...
    version: V_COM2,
    a: { atk:0, rtbType:'lightning', rtb:4, toHitRtbMod:70, hp:10, abilities: { destiny: true } },
    b: { def:0, hp:30 },
  ...
  destinyThrownDoublesCoM2: {
    ...
    version: V_COM2,
    a: { atk:0, rtbType:'thrown', rtb:5, toHitRtbMod:70, hp:10, abilities: { destiny: true } },
    b: { def:0, hp:30 },
  ...
  destinyAfterLuckyStarWarlord: {
    ...
    version: V_WARLORD,
    a: { atk:3, toHitMod:70, hp:10, abilities: { luckyStar: true, apotheosis: true } },

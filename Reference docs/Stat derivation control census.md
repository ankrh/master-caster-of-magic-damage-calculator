...
|---|---|---|
| P1 — DOS cast boundary preparation | Approved; [task scope](../TASKS.md#approved-pilot-source-preparation). | Required engine schedule input to F279.2 and .3c/.3b. |
| P2 — modern pilot targeting/boundary preparation | Approved; [task scope](../TASKS.md#approved-pilot-source-preparation). | Required engine input to F279.2 and .3c/.3b. |

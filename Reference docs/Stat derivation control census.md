...
|---|---|---|
| P1 — DOS cast boundary preparation | Complete; [source inventory](DOS%20reconstructed/P1.holy-weapon-cast-boundary.md). | Required engine schedule input to F279.2 and .3c/.3b. |
| P2 — modern pilot targeting/boundary preparation | Complete; [source inventory](Caster%20binary/P2.holy-weapon-cast-boundary.md). | Required engine input to F279.2 and .3c/.3b. |

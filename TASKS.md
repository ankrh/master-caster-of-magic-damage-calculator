...
| 4 | **F277.2** | Settle the repeated-execution representation for the shared design. Uses the completed [execution census](Reference%20docs/DOS%20reconstructed/F277.1.execution-census.md). |
| 5 | **F279.2** | Design the outer cast sequence, record ownership, recalculation boundaries and traces. Needs F277.2, F250.2, F250.3 and F250.4; uses completed F236.1. |
...
- **F279.2** settle one design from the completed census, F277.2 and the relevant admission evidence. Separate
  ...
  `PROPOSALS.md`. No code migration. Needs F277.2, F250.2, F250.3 and F250.4; uses completed F236.1.

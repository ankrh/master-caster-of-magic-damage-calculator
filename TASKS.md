...
|---|---|---|
| 1 | **P8.1** | Map MoM 1.31's two Specials calls, arguments and reset/retain boundaries. Documentation, no reconstruction. |
| 2 | **F279.2** | Design the outer cast sequence, record ownership, recalculation boundaries and traces. Needs P8.1 and required resulting engine evidence; uses completed P1, P2, F250, F236.1 and F277.2. |
...
- **F279.2** settle one design from the completed census, the completed [invocation decision](Reference%20docs/DOS%20reconstructed/F277.2.invocation-decision.md) and the relevant admission evidence. Separate
  ...
  `PROPOSALS.md`. No code migration. Needs P8.1 and required resulting engine evidence; uses completed P1, P2, F250, F236.1 and F277.2.

...
// `tools/preset_checks.js` is the one that evaluates a preset (F260.9). Reconstructing the
// translation a second time, here or anywhere, is still prohibited, and so is reading the card off
// anything but a card state.
//

...
DEFAULT_SOURCE = REPO_ROOT / "Reference docs" / "Warlord_Manual v1.5.12.9.pdf"
DEFAULT_OUTPUT = REPO_ROOT / "Reference docs" / "Warlord manual v1.5.12.9.html"
...
def build_html(source: Path) -> tuple[str, dict[str, int | str]]:
    ...
    title = "Caster of Magic Warlord Mod Manual — v1.5.12.9"
    body = "\n".join(pages)
...
<header class="document-note">
  ...
  <p>Searchable HTML derived from
    <a href="Warlord_Manual%20v1.5.12.9.pdf">Warlord_Manual v1.5.12.9.pdf</a>.
